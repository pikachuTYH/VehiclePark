...
public class DisplayCar extends JFrame implements ActionListener {

    JFrame DP = new JFrame("Display Current Car - Car Parking System");
    JButton ProceedBtn;
    JTextField textField;
    JTextArea textArea;
    Everything ev;

    protected DisplayCar(Everything e) {
        ev = e;
