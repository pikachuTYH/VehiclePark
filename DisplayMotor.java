...
public class DisplayMotor extends JFrame implements ActionListener {

    JFrame DP = new JFrame("Display Current Motor - Car Parking System");
    JButton ProceedBtn;
    JTextField textField;
    JTextArea textArea;
    Everything ev;

    protected DisplayMotor(Everything e) {
        ev = e;
